	...
	<section class="cf-home-hero">
		<div class="cf-container">
			<a class="cf-home-banner" href="<?php echo esc_url( $shop_url ); ?>">
				<img src="<?php echo esc_url( content_url( 'uploads/cloudfront-assets/home-banner-1300x600.png' ) ); ?>" alt="Banner">
			</a>
		</div>
	</section>
		...
		<div class="cf-container">
			<div class="cf-promo-grid">
				<div class="cf-promo-item">
					<img src="<?php echo esc_url( content_url( 'uploads/cloudfront-assets/promo-worldwide-shipping.png' ) ); ?>" alt="Promotion Icon" loading="lazy">
					<div>
						<h3>Worldwide Shipping</h3>
						<p>Fast production and delivery for every order.</p>
					</div>
				</div>
				<div class="cf-promo-item">
					<img src="<?php echo esc_url( content_url( 'uploads/cloudfront-assets/promo-secure-payment.png' ) ); ?>" alt="Promotion Icon" loading="lazy">
					<div>
				...
				<div class="cf-promo-item">
					<img src="<?php echo esc_url( content_url( 'uploads/cloudfront-assets/promo-support-247.png' ) ); ?>" alt="Promotion Icon" loading="lazy">
					<div>
						<h3>Support 24/7</h3>
						<p>Friendly help whenever customers need it.</p>
					</div>
				</div>
			</div>
		</div>
